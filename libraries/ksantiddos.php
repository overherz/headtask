...
class ksantiddos
{
	...
	function doit($hits_limit,$seconds_limit,$memlen=300000)
	{
		...
		if (rand(1,500)==1)
		{ 	// very upsetting bug of shared memory. sometimes (very seldom) function shm_put_var dies without even replying allready printed data. 
			// randomly reseting shared memory to avoid this trouble. thinking of basing ksantiddos on MEMORY mysql tables.
